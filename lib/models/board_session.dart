...
/// D-148: every Council session is typed. `setup` covers the whole pyramid
/// and exists at most once per account, ever; every session after setup is
/// `category`-typed and scoped to exactly one category (D-145). D-075 adds
...
/// D-148/D-145: a Council session, ported from Kansei's `BoardSession`
