...
import 'package:life_ops/screens/setup/setup9.dart';
...
class _Setup8State extends State<Setup8> {
  ...
  Widget build(BuildContext context) {
    analytics.logEvent(name: '${setupVersion}_setup8');
    Color green =
    ...
    return SafeArea(
        child: Scaffold(
            ...
            body: Center(
              ...
              ProgressBar(currentStep: 7, totalSteps: 23),
  ...
  void navigateToSetup9() async {
    await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const Setup9()),
    );
  }
}
