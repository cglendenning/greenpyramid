...
import 'package:life_ops/screens/setup/tasks/cat1tasks.dart';
...
class Setup13 extends StatefulWidget {
  ...
  const Setup13(this.dd1Value, this.dd2Value, this.dd3Value);

  @override
  State<Setup13> createState() => _Setup13State(dd1Value, dd2Value, dd3Value);
}

class _Setup13State extends State<Setup13> {
  String dd1Value;
  String dd2Value;
  String dd3Value;
