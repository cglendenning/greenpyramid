...
import 'package:life_ops/screens/setup/tasks/cat3tasks.dart';
...
class _Cat2TasksState extends State<Cat2Tasks> {
    ...
    return SafeArea(
        child: Scaffold(
            ...
            body: Center(
              ...
              ProgressBar(currentStep: 15, totalSteps: 23),
                  ...
                  child: Scrollbar(
                      child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return ListTile(
                              title: Text(tasksForCat2[index].taskdescription),
                              subtitle: Column(
                                  ...
                                  onTap: () {
                                    setState(() {
                                      showDeleteAlertDialog(context,
                                          tasksForCat2[index].taskdescription);
                                    });
                                  },
  ...
  void navigateToCat3Tasks() async {
    ...
    await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Cat3Tasks(foundCat.cat)),
