...
/// D-148: resonance scoring is ported as-is, AI-free.
void main() {
  group('D-148: resonance scoring is pure and AI-free', () {
    test('D-148: text under the minimum length scores zero', () {
      expect(ResonanceService.score('too short'), 0.0);
    });

    test('D-148: a bare, unconvicted long statement scores above zero from '
        'length alone', () {
      final text = 'x' * 200;
      expect(ResonanceService.score(text), greaterThan(0.0));
    });

    test('D-148: conviction markers raise the score above length alone', () {
      final plain = 'x' * 60;
      final withMarkers =
    ...
    test('D-148: score never exceeds 1.0 regardless of length or marker '
        'density', () {
    ...
    test('D-148: qualifies is true iff score is above zero', () {
    ...
    test('D-148: minStatementLength is the documented floor of 40', () {
