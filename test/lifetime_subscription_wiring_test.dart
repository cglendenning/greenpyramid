...
void main() {
  ...
  test('D-167-AC-04: Settings exposes lifetime redemption and cache support',
    ...
    expect(db, contains('_databaseVersion = 26'));
  });
  ...
  test('D-167-AC-06: consumer and admin source contain the lifetime feature',
      () {
    expect(File('admin/lib/main.dart').readAsStringSync(),
        contains('/adminLifetimeCode'));
    expect(File('lib/screens/settings.dart').readAsStringSync(),
        contains('D-167'));
  });
}
